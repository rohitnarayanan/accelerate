...
public final class JSONUtil {
	 ...
	 *
	 * @param aInclude
	 *            {@link Boolean} value to indicated whether the JSON string should
	 *            be contain fields with empty/null values
	 * @param aIndent
	 *            {@link Boolean} value to indicated whether the JSON string should
	 *            be indented or not
	 * @param aQuoteFieldNames
	 *            {@link Boolean} value to indicated whether the field names in the
	 *            JSON string should be quoted(") or not
	 ...
	 *            {@link Boolean} value to indicated whether the defaut json view
	 ...
	 *            Object to be converted to JSON string
	 * @param aObjectMapper
	 *            pre-configured instance of {@link ObjectMapper}
	 * @return JSON string
	 * @throws AccelerateException
	 */
	private static String serialize(Object aObject, ObjectMapper aObjectMapper) throws AccelerateException {
		if (isEmpty(aObject)) {
			return EMPTY_STRING;
		}
	 ...
	 * @param aClass
	 *            {@link Class} which should be instantiated from the JSON string
