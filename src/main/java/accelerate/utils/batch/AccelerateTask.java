...
/**
 * Abstract implementation for {@link Callable} with utility methods
 * 
 * @version 1.0 Initial Version
 * @author Rohit Narayanan
 * @since October 2, 2017
 */
public abstract class AccelerateTask extends DataBean implements Callable<AccelerateTask> {
	/**
	 * serialVersionUID
	 */
	...
	/**
	 * {@link List} of {@link Consumer} registered to to be called after execution
	 */
	private Consumer<AccelerateTask> postProccessor = null;

	/**
	 * {@link System#currentTimeMillis()} when the task was submitted for execution
	 */
	...
	/**
	 * This method is a utility provided to implementations of this class to pause
	 * execution on receiving an interrupt by {@link AccelerateBatch}
	 *
	 * @throws AccelerateException
